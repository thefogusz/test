            ...
            try {
              ...
              if (!html) {
                html = `<!doctype html><html lang="en"><head>
                  ...
                  <h1>Dev mock: full article unavailable in local environment</h1>
                  <p>This is a placeholder article generated by the local dev server because the upstream URL could not be fetched (no internet or CORS restriction).</p>
                  <p>In production this section will contain the real article body extracted by Readability. The Thai translation pipeline will then translate it via the Grok API and display the result in the reader modal.</p>
                  <p>Engineers testing the translation UI can verify the flow is working correctly by checking that this text appears translated into Thai below.</p>
                </article></body></html>`
              }
