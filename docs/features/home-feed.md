...
flowchart TD
    ...
    subgraph Orchestration["useHomeFeedWorkspace.ts"]
        MERGE["merge + fingerprint dedup"]
        SORT["sort by created_at\n(X + RSS รวมกัน)"]
        WINDOW["soft window\n20 items รอบแรก"]
        PENDING["pendingFeed\n(overflow queue)"]
        LIMIT["pricingPlans.ts\nFree: 30 / Plus: 100"]
    end
    ...
    style Orchestration fill:#1e1b4b,stroke:#3730a3
    style AI fill:#1c1917,stroke:#78350f
