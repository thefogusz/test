...
- เปิดเป็นค่าเริ่มต้นผ่าน `activeView = "home"` ใน [src/App.tsx](/D:/Work/FORO-MOCK/test/src/App.tsx)
- แสดง feed หลักผ่าน [HomeView.tsx](/D:/Work/FORO-MOCK/test/src/components/HomeView.tsx) และ render รายการแต่ละชิ้นผ่าน [FeedCard.tsx](/D:/Work/FORO-MOCK/test/src/components/FeedCard.tsx)
...
- [src/App.tsx](/D:/Work/FORO-MOCK/test/src/App.tsx)
- [src/components/HomeView.tsx](/D:/Work/FORO-MOCK/test/src/components/HomeView.tsx)
- [src/components/FeedCard.tsx](/D:/Work/FORO-MOCK/test/src/components/FeedCard.tsx)
- [src/components/AiFilterModal.tsx](/D:/Work/FORO-MOCK/test/src/components/AiFilterModal.tsx)
- [src/hooks/useHomeFeedWorkspace.ts](/D:/Work/FORO-MOCK/test/src/hooks/useHomeFeedWorkspace.ts)
- [src/services/GrokService.ts](/D:/Work/FORO-MOCK/test/src/services/GrokService.ts)
