...
hero:
  name: "Foro Docs"
  text: "เอกสาร product และ engineering ที่อิงระบบจริง"
  tagline: "ให้ทีมเปิดที่เดียวแล้วเข้าใจได้ทันทีว่าฟีเจอร์ทำงานยังไง ตอนนี้อะไรเปลี่ยนไป และจุดไหนต้องตามเอกสารต่อ"
  actions:
    - theme: brand
      text: เริ่มอ่าน
